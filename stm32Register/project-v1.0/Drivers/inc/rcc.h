...
#define SYSCLK_FREQ_72MHZ 0
#define SYSCLK_FREQ_56MHZ 1
#define SYSCLK_FREQ_48MHZ 2
#define SYSCLK_FREQ_36MHZ 3
#define SYSCLK_FREQ_24MHZ 4

typedef enum
{
    RCC_CLOCK_CFG_72MHZ = 0,
    RCC_CLOCK_CFG_56MHZ,
    RCC_CLOCK_CFG_48MHZ,
    RCC_CLOCK_CFG_36MHZ,
    RCC_CLOCK_CFG_24MHZ
...
typedef struct
{
    RCC_ClockSource source; // HSE hoặc HSI
